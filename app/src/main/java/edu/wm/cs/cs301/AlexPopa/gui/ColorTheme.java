...
public class ColorTheme {
	...
	private static class ColorSettings {
		...
		int getWallColor(final int distance, final int cc, final int extensionX) {
			LOGGER.log(Level.FINEST, "regardless of input, returns color: " + Color.DKGRAY);
			return Color.LTGRAY;
	    }
	...
	private static class ColorSettingsBasic extends ColorSettings {
	    ...
	    int getWallColor(final int distance, final int cc, final int extensionX) {
	        ...
	        switch (((d >> 3) ^ cc) % 6) {
	        case 0:
	            result = Color.rgb(rgbValue, RGB_DEF, RGB_DEF);
	            break;
	        case 1:
	        	result = Color.rgb(RGB_DEF, rgbValue, RGB_DEF);
	        	break;
	        case 2:
	        	result = Color.rgb(RGB_DEF, RGB_DEF, rgbValue);
	        	break;
	        case 3:
	        	result = Color.rgb(rgbValue, rgbValue, RGB_DEF);
	        	break;
	        case 4:
	        	result = Color.rgb(RGB_DEF, rgbValue, rgbValue);
	        	break;
	        case 5:
	        	result = Color.rgb(rgbValue, RGB_DEF, rgbValue);
	        	break;
	        default:
	        	result = Color.rgb(RGB_DEF, RGB_DEF, RGB_DEF);
	        	break;
	        }
	...
	private static class ColorSettingsAdvanced extends ColorSettings {
		...
		private int blend(int fstColor, int sndColor, double weightFstColor) {
		    ...
		    return (Color.argb((float) r, (float) g, (float) b, (float) a));
		  }
		/**
	     * Default minimum value for RGB values.
	     */
	    ...
	    int getWallColor(final int distance, final int cc, final int extensionX) {
	        ...
	        case 0:
	            ...
	            break;
	        case 1:
	        	result = Color.rgb(RGB_DEF, RGB_DEF_GREEN, RGB_DEF);
	        	break;
	        case 2:
	        	result = Color.rgb(RGB_DEF, RGB_DEF, rgbValue);
	        	break;
	        case 3:
	        	result = Color.rgb(rgbValue, RGB_DEF_GREEN, RGB_DEF);
	        	break;
	        case 4:
	        	result = Color.rgb(RGB_DEF, RGB_DEF_GREEN, rgbValue);
	        	break;
	        case 5:
	        	result = Color.rgb(rgbValue, RGB_DEF, rgbValue);
	        	break;
