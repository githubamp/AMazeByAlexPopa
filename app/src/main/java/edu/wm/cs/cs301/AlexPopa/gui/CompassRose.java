...
public class CompassRose {
	...
	private void drawArms(final MazePanel g2, final int length, final int width) {
        ...
        g2.setColor(ColorTheme.getColor(COMPASSROSE_MAIN_COLOR));
        // draw each arm
...
/*	private void drawBorderCircle(MazePanel g2, int width) {
		...
		// draw both arcs
		g2.setColor(ColorTheme.getColor(COMPASSROSE_CIRCLE_SHADE));
	...
	private void drawDirectionMarker(MazePanel g2, int width) {
		...
		g2.setColor((CardinalDirection.South == currentDir) ? 
				ColorTheme.getColor(ColorTheme.MazeColors.COMPASSROSE_MARKER_COLOR_CURRENTDIRECTION) :
					ColorTheme.getColor(COMPASSROSE_MARKER_COLOR_DEFAULT));
		drawMarker(g2, centerX, centerY - offset, "N");

		g2.setColor((CardinalDirection.East == currentDir) ? 
				ColorTheme.getColor(COMPASSROSE_MARKER_COLOR_CURRENTDIRECTION) :
					ColorTheme.getColor(COMPASSROSE_MARKER_COLOR_DEFAULT));
